...
sns.catplot(x="serum cat", y="OD", hue="serum cat", col_order=antigens, col="antigen",kind="swarm", palette=palette,data=serum_df, col_wrap = 5)
...
# Draw a categorical scatterplot to show each observation
palette = sns.color_palette(n_colors=len(serum_df[hue].unique()))
g=sns.catplot(x="serum cat", y="OD", hue="serum cat", col_order=antigens, col="antigen",kind="swarm", palette=palette,data=serum_df, ax=ax, col_wrap = 5)
g.set(ylim=(-0.05,0.2))
