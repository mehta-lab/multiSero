...
# %% First path
data_folder1 = r'/Volumes/GoogleDrive/My Drive/ELISAarrayReader/images_scienion/2020-06-24-17-25-28-COVID_June24_OJassay_plate9_images/Stitched data from multiple pysero outputs/pysero_biotin_fiducial_20200701_0933'
...
# %% Second path
data_folder2 = r'/Volumes/GoogleDrive/My Drive/ELISAarrayReader/images_scienion/2020-06-24-17-25-28-COVID_June24_OJassay_plate9_images/Stitched data from multiple pysero outputs/pysero_igg_fiducial_20200701_1002'
...
failed_wells2 = ['B7', 'B8', 'B10','B11','D3','D8','D9','D10','D11','F8','F9','F11','H2','H7','H8','H9','H10','H11']
for failed_well in failed_wells2:
    python_df2 = python_df2[python_df2.well_id != failed_well]

wells2keep3 = ['B7', 'B8', 'B10','B11','D3','D8','D9','D10','D11','F8','F9','F11','H2','H7','H8','H9','H10','H11']
...
stitchedpython_df.to_excel(r'/Users/janie.byrum/Desktop/dataframes output/plate9.xlsx')
...
plt.savefig(os.path.join(fig_path, '{}_{}_{}_fit.jpg'.format('mab', sec_id, sec_dilutions)),dpi=300, bbox_inches='tight')
...
plt.savefig(os.path.join(fig_path, '{}_{}_{}_fit.jpg'.format('mab zoom', sec_id, sec_dilutions)),dpi=300, bbox_inches='tight')
