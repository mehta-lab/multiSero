...
# %% First path
data_folder1 = r'/Volumes/GoogleDrive/My Drive/ELISAarrayReader/images_scienion/2020-06-24-17-29-42-COVID_June24_OJassay_plate10_images/Stitched data from multiple pysero outputs/pysero_biotin_fiducial_20200701_1047'
...
failed_wells2 = ['B12','D2','D3','D1','D5','H2','H5']
for failed_well in failed_wells2:
    python_df2 = python_df2[python_df2.well_id != failed_well]

wells2keep3 = ['B12','D1','D5','D2','D3','H2']
